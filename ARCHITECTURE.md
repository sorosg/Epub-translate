...
### 3.4. UserBookPreference (ÚJ v11.0.59)
...
```
epub-translator/
├── install.sh                    # Telepítő/frissítő script (2300 sor, v11.0.59)
...
### Adatbázis migráció v11.0.58 → v11.0.59
```sql
...
*Ez a dokumentum a projekttel együtt frissítendő. Utolsó módosítás: 2026-07-17 (v11.0.59)*